return {
	...
	config = function()
		...
		local gs = { hidden = true, no_ignore = true, file_ignore_patterns = { ".git/", "target/", "%.lock" } }
		...
		vim.keymap.set("n", "<space>sh", function()
			builtin.help_tags(gs)
		end, { desc = "Neovim documentation" })
