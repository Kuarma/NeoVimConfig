...
K("n", "<C-Right>", "<cmd>vertical resize -2<cr>", { desc = "Decrease width" })
K("n", "<C-Down>", "<cmd>resize -2<cr>", { desc = "Decrease height" })
K("n", "<C-Up>", "<cmd>resize +2<cr>", { desc = "Increase height" })
K("n", "<C-Left>", "<cmd>vertical resize +2<cr>", { desc = "Increase width" })
...
K("n", "<C-w>t", "<cmd>tabnew<cr>", { desc = "Open new tab" })
